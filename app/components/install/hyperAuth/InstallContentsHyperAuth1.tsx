...
function InstallContentsHyperAuth1(props: any) {
  console.debug(InstallContentsHyperAuth1.name, props);
    ...
    <div className={[styles.wrap, 'childLeftRightCenter'].join(' ')}>
      <div>
        <div className={styles.contents}>
              ...
              <div className={[styles.insideCircle].join(' ')}>
                ...
                <div>
                  <span className={['large', 'thick'].join(' ')}>
                    {CONST.PRODUCT.HYPERAUTH.NAME}
                  </span>
                </div>
                <div>
                  <span className={['small', 'lightDark'].join(' ')}>
                    {CONST.PRODUCT.HYPERAUTH.DESC}
                  </span>
                </div>
              </div>
            </MuiBox>
          ...
          <div>
            <span className={['medium', 'lightDark'].join(' ')}>{CONST.PRODUCT.HYPERAUTH.NAME} 를 설치할 수 있습니다.</span>
            <br />
...
export default InstallContentsHyperAuth1;
