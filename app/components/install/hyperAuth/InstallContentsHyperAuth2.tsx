...
function InstallContentsHyperAuth2(props: any) {
  console.debug(InstallContentsHyperAuth2.name, props);
      ...
      >
        <Button
          ...
          onClick={() => {
            dispatchAppState({
              type: 'set_installing',
              installing: CONST.PRODUCT.HYPERAUTH.NAME
            });
            history.push(
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              <span className={['lightDark', 'small'].join(' ')}>
                {CONST.PRODUCT.HYPERAUTH.NAME} 설정 화면에서 나가시겠습니까? 설정
                내용은 저장되지 않습니다.
              </span>
            </DialogContentText>
          </DialogContent>
...
export default InstallContentsHyperAuth2;
