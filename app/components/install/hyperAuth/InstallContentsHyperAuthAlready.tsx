...
function InstallContentsHyperAuthAlready(props: any) {
  console.debug(InstallContentsHyperAuthAlready.name, props);
  ...
  const nowProduct = CONST.PRODUCT.HYPERAUTH;
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  <span className={['lightDark', 'small'].join(' ')}>
                    {CONST.PRODUCT.HYPERAUTH.NAME} 를 삭제하시겠습니까?
                  </span>
                </DialogContentText>
              </DialogContent>
              <DialogActions>
...
export default InstallContentsHyperAuthAlready;
