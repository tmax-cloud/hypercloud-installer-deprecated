...
import productImage from '../../../../resources/assets/Prometheus_logo.png';
import * as env from '../../../utils/common/env';
import CONST from '../../../utils/constants/constant';

function InstallContentsPrometheus1(props: any) {
    ...
    <div className={[styles.wrap, 'childLeftRightCenter'].join(' ')}>
      <div>
        <div className={styles.contents}>
              ...
              <div className={[styles.insideCircle].join(' ')}>
                ...
                <div>
                  <span className={['large', 'thick'].join(' ')}>
                    {CONST.PRODUCT.PROMETHEUS.NAME}
                  </span>
                </div>
                <div>
                  <span className={['small', 'lightDark'].join(' ')}>
                    {CONST.PRODUCT.PROMETHEUS.DESC}
                  </span>
                </div>
              </div>
            </MuiBox>
          ...
          <div>
            <span className={['medium', 'lightDark'].join(' ')}>{CONST.PRODUCT.PROMETHEUS.NAME} 를 설치할 수 있습니다.</span>
            <br />
...
export default InstallContentsPrometheus1;
