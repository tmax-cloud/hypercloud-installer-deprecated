...
function InstallContentsCatalogController1(props: any) {
  console.debug(InstallContentsCatalogController1.name, props);
    ...
    <div className={[styles.wrap, 'childLeftRightCenter'].join(' ')}>
      <div>
        <div className={styles.contents}>
              ...
              <div className={[styles.insideCircle].join(' ')}>
                ...
                <div>
                  <span className={['large', 'thick'].join(' ')}>
                    {CONST.PRODUCT.CATALOG_CONTROLLER.NAME}
                  </span>
                </div>
                <div>
                  <span className={['small', 'lightDark'].join(' ')}>
                    {CONST.PRODUCT.CATALOG_CONTROLLER.DESC}
                  </span>
                </div>
              </div>
            </MuiBox>
          ...
          <div>
            <span className={['medium', 'lightDark'].join(' ')}>{CONST.PRODUCT.CATALOG_CONTROLLER.NAME} 를 설치할 수 있습니다.</span>
            <br />
...
export default InstallContentsCatalogController1;
